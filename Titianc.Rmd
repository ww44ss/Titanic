...
Age data substitution appears to be a critical factor in model accuracy. Age plays a strong role in survivability. Since there are a lorge number of NAs in the age data which need to be modeled, let's see if the method of directly substituting mean age can be improved.  
